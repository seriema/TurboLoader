...
namespace RetroUi
{
	...
	public:
		...
		inline const RenderData_Draw data( Entity e ) { return get( _data.data, e ); }
		inline void set_data( Entity e, RenderData_Draw data ) { set( _data.data, e, data ); }
	};
}
